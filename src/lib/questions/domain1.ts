...
export const domain1Questions: Question[] = [
  ...
  },
  {
    id: 'd1-026',
    domainId: 1,
    questionText: 'Which of the following is a benefit of moving to the AWS Cloud in terms of pricing?',
    questionType: 'single_choice',
    options: [
      { id: 'a', text: 'Capital expenses (CapEx) are replaced by variable expenses (OpEx)' },
      { id: 'b', text: 'Variable expenses (OpEx) are replaced by capital expenses (CapEx)' },
      { id: 'c', text: 'Customers pay a fixed monthly fee regardless of usage' },
      { id: 'd', text: 'Hardware maintenance costs are billed annually' },
    ],
    correctAnswers: ['a'],
    explanation: 'One of the main benefits of the AWS Cloud is the ability to trade capital expense (CapEx) for variable expense (OpEx). You pay only when you consume computing resources and only for how much you consume, instead of heavily investing in data centers and servers before you know how you are going to use them.',
    referenceLinks: [
  ...
  },
  {
    id: 'd1-027',
    domainId: 1,
    questionText: 'Which design principle is achieved by distributing an application across multiple Availability Zones?',
    questionType: 'single_choice',
    options: [
      { id: 'a', text: 'Agility' },
      { id: 'b', text: 'High Availability' },
      { id: 'c', text: 'Elasticity' },
      { id: 'd', text: 'Economy of scale' },
    ],
    correctAnswers: ['b'],
    explanation: 'High Availability is achieved by deploying applications across multiple Availability Zones within an AWS Region. This ensures that if one AZ goes down, the application remains accessible from another AZ.',
    referenceLinks: [
      { text: 'AWS Reliability Pillar', url: 'https://docs.aws.amazon.com/wellarchitected/latest/reliability-pillar/reliability.html' },
    ],
    difficulty: 'easy',
    isUnscored: false,
    tags: ['design-principles', 'high-availability', 'architecture'],
  },
  {
    id: 'd1-028',
    domainId: 1,
    questionText: 'A company wants to evaluate its AWS architecture against best practices. Which AWS service provides guidance based on the AWS Well-Architected Framework?',
    questionType: 'single_choice',
    options: [
      { id: 'a', text: 'AWS Trusted Advisor' },
      { id: 'b', text: 'AWS Well-Architected Tool' },
    ...
    correctAnswers: ['b'],
    explanation: 'The AWS Well-Architected Tool helps you review the state of your workloads and compares them to the latest AWS architectural best practices, providing guidance to improve your cloud architectures.',
    referenceLinks: [
      { text: 'AWS Well-Architected Tool', url: 'https://aws.amazon.com/well-architected-tool/' },
    ],
    difficulty: 'medium',
    isUnscored: false,
    tags: ['well-architected', 'tools'],
  },
  {
    id: 'd1-029',
    domainId: 1,
    questionText: 'Which concept refers to the ability of a system to automatically scale its capacity up or down based on demand?',
    questionType: 'single_choice',
    options: [
      { id: 'a', text: 'High Availability' },
    ...
    correctAnswers: ['c'],
    explanation: 'Elasticity is the ability to acquire resources as you need them and release resources when you no longer need them. In the cloud, this means scaling out or scaling in automatically in response to demand.',
    referenceLinks: [
      { text: 'Cloud Computing Concepts', url: 'https://aws.amazon.com/what-is-cloud-computing/' },
    ],
    difficulty: 'easy',
    isUnscored: false,
  ...
  },
  {
    id: 'd1-030',
    domainId: 1,
    questionText: 'Which AWS perspective of the AWS Cloud Adoption Framework (AWS CAF) helps organizations design, implement, and optimize their AWS infrastructure based on business goals?',
    questionType: 'single_choice',
    options: [
      { id: 'a', text: 'Business Perspective' },
      { id: 'b', text: 'Platform Perspective' },
      { id: 'c', text: 'Operations Perspective' },
      { id: 'd', text: 'Security Perspective' },
    ],
    correctAnswers: ['b'],
    explanation: 'The Platform Perspective of the AWS CAF helps organizations design, implement, and optimize the architecture of AWS technology based on business goals and objectives.',
    referenceLinks: [
      { text: 'AWS Cloud Adoption Framework', url: 'https://aws.amazon.com/cloud-adoption-framework/' },
    ],
    difficulty: 'medium',
    isUnscored: false,
    tags: ['caf', 'cloud-adoption-framework', 'platform-perspective'],
  },
  {
    id: 'd1-031',
    domainId: 1,
    questionText: 'What is the primary benefit of the "Stop guessing capacity" design principle of the AWS Well-Architected Framework?',
    questionType: 'single_choice',
    options: [
      { id: 'a', text: 'Eliminating the need for security assessments' },
      { id: 'b', text: 'Reducing the risk of over-provisioning or under-provisioning resources' },
      { id: 'c', text: 'Automating the creation of AWS accounts' },
      { id: 'd', text: 'Bypassing the need for multi-AZ deployments' },
    ],
    correctAnswers: ['b'],
    explanation: 'By using cloud computing, you can access as much or as little capacity as you need, and scale up and down as required with only a few minutes notice, thereby eliminating the risk of over-provisioning (wasting money) or under-provisioning (poor performance).',
    referenceLinks: [
      { text: 'Design Principles', url: 'https://docs.aws.amazon.com/wellarchitected/latest/framework/general-design-principles.html' },
    ],
    difficulty: 'easy',
    isUnscored: false,
  ...
  },
  {
    id: 'd1-032',
    domainId: 1,
    questionText: 'A company wants to migrate its on-premises data center to AWS and completely shut down its physical servers. Which migration strategy does this represent?',
    questionType: 'single_choice',
    options: [
      { id: 'a', text: 'Hybrid Cloud' },
      { id: 'b', text: 'All-in Cloud (Cloud Native)' },
      { id: 'c', text: 'Multi-Cloud' },
      { id: 'd', text: 'On-premises deployment' },
    ],
    correctAnswers: ['b'],
    explanation: 'An All-in Cloud (or cloud-native) deployment model involves migrating all parts of the application to the cloud and shutting down on-premises data centers.',
    referenceLinks: [
      { text: 'Types of Cloud Computing', url: 'https://aws.amazon.com/what-is-cloud-computing/' },
    ],
    difficulty: 'easy',
    isUnscored: false,
    tags: ['migration', 'deployment-models'],
  },
  {
    id: 'd1-033',
    domainId: 1,
    questionText: 'Which feature of the AWS Cloud enables customers to innovate faster by quickly deploying new applications?',
    questionType: 'single_choice',
    options: [
      { id: 'a', text: 'Massive economies of scale' },
      { id: 'b', text: 'Agility' },
      { id: 'c', text: 'Global footprint' },
      { id: 'd', text: 'Trade capital expense for variable expense' },
    ],
    correctAnswers: ['b'],
    explanation: 'Agility in the cloud allows organizations to rapidly develop, test, and launch applications. IT resources are only a click away, reducing the time it takes to make those resources available to developers from weeks to just minutes.',
    referenceLinks: [
      { text: 'Six Advantages of Cloud Computing', url: 'https://docs.aws.amazon.com/whitepapers/latest/aws-overview/six-advantages-of-cloud-computing.html' },
    ],
    difficulty: 'medium',
    isUnscored: false,
    tags: ['cloud-concepts', 'agility'],
  },
  {
    id: 'd1-034',
    domainId: 1,
    questionText: 'Which migration strategy (from the 7 Rs) involves moving an application to AWS without making any changes to its architecture?',
    questionType: 'single_choice',
    options: [
      { id: 'a', text: 'Replatforming' },
      { id: 'b', text: 'Rehosting' },
      { id: 'c', text: 'Refactoring' },
      { id: 'd', text: 'Repurchasing' },
    ],
    correctAnswers: ['b'],
    explanation: 'Rehosting, also known as "lift and shift," involves moving an application to the cloud as-is, without making any changes to its underlying architecture.',
    referenceLinks: [
      { text: 'Migration Strategies (7 Rs)', url: 'https://docs.aws.amazon.com/prescriptive-guidance/latest/migration-strategies/strategy-rehost.html' },
    ],
    difficulty: 'medium',
    isUnscored: false,
    tags: ['migration', '7-rs', 'rehost'],
  },
  {
    id: 'd1-035',
    domainId: 1,
    questionText: 'Which pillar of the AWS Well-Architected Framework focuses on the ability of a workload to perform its intended function correctly and consistently?',
    questionType: 'single_choice',
    options: [
      { id: 'a', text: 'Operational Excellence' },
      { id: 'b', text: 'Security' },
    ...
    referenceLinks: [
      { text: 'Reliability Pillar', url: 'https://docs.aws.amazon.com/wellarchitected/latest/reliability-pillar/reliability.html' },
    ],
    difficulty: 'easy',
    isUnscored: false,
    tags: ['well-architected', 'reliability'],
  },
  {
    id: 'd1-036',
    domainId: 1,
    questionText: 'A company wants to transition from monolithic application architecture to microservices. Which migration strategy does this represent?',
    questionType: 'single_choice',
    options: [
      { id: 'a', text: 'Rehosting' },
      { id: 'b', text: 'Replatforming' },
      { id: 'c', text: 'Refactoring / Rearchitecting' },
      { id: 'd', text: 'Retaining' },
    ],
    correctAnswers: ['c'],
    explanation: 'Refactoring or Rearchitecting involves reimagining how the application is architected and developed, typically by using cloud-native features like microservices, serverless, or containers. This is usually driven by a strong business need to add features, scale, or performance that would otherwise be difficult to achieve in the existing environment.',
    referenceLinks: [
      { text: 'Migration Strategies', url: 'https://docs.aws.amazon.com/prescriptive-guidance/latest/migration-strategies/strategy-refactor.html' },
    ],
    difficulty: 'medium',
    isUnscored: false,
    tags: ['migration', '7-rs', 'refactor'],
  },
  {
    id: 'd1-037',
    domainId: 1,
    questionText: 'Which of the following describes the AWS Shared Responsibility Model?',
    questionType: 'single_choice',
    options: [
      { id: 'a', text: 'AWS is responsible for security OF the cloud, while the customer is responsible for security IN the cloud.' },
      { id: 'b', text: 'AWS manages all security aspects of customer applications.' },
      { id: 'c', text: 'The customer is responsible for the physical security of AWS data centers.' },
      { id: 'd', text: 'AWS and the customer share equal responsibility for configuring IAM policies.' },
    ],
    correctAnswers: ['a'],
    explanation: 'In the AWS Shared Responsibility Model, AWS is responsible for the security OF the cloud (protecting the infrastructure that runs all of the services offered in the AWS Cloud). The customer is responsible for security IN the cloud (customer data, IAM, OS patching for EC2, etc.).',
    referenceLinks: [
  ...
  },
  {
    id: 'd1-038',
    domainId: 1,
    questionText: 'How does AWS achieve "massive economies of scale"?',
    questionType: 'single_choice',
    options: [
      { id: 'a', text: 'By requiring customers to sign long-term contracts' },
      { id: 'b', text: 'By aggregating usage from hundreds of thousands of customers, allowing AWS to achieve higher economies of scale and pass savings on to customers' },
      { id: 'c', text: 'By using open-source software exclusively' },
      { id: 'd', text: 'By hosting all customer data in a single global data center' },
    ],
    correctAnswers: ['b'],
    explanation: 'Because usage from hundreds of thousands of customers is aggregated in the cloud, AWS can achieve higher economies of scale, which translates into lower pay-as-you-go prices for customers.',
    referenceLinks: [
      { text: 'Six Advantages of Cloud Computing', url: 'https://docs.aws.amazon.com/whitepapers/latest/aws-overview/six-advantages-of-cloud-computing.html' },
    ],
    difficulty: 'medium',
  ...
  },
  {
    id: 'd1-039',
    domainId: 1,
    questionText: 'What is the benefit of deploying an application in multiple AWS Regions?',
    questionType: 'single_choice',
    options: [
      { id: 'a', text: 'It reduces the cost of running EC2 instances' },
      { id: 'b', text: 'It decreases the latency for users located around the world' },
      { id: 'c', text: 'It automatically translates the application into different languages' },
      { id: 'd', text: 'It guarantees that the application will never experience downtime' },
    ],
    correctAnswers: ['b'],
    explanation: 'Deploying an application in multiple Regions around the world allows you to provide lower latency and a better experience for your customers at minimal cost.',
    referenceLinks: [
      { text: 'Global Footprint', url: 'https://docs.aws.amazon.com/whitepapers/latest/aws-overview/six-advantages-of-cloud-computing.html' },
    ],
    difficulty: 'easy',
    isUnscored: false,
    tags: ['cloud-concepts', 'global-infrastructure'],
  },
  {
    id: 'd1-040',
    domainId: 1,
    questionText: 'According to the AWS Well-Architected Framework, which of the following is a design principle for the Performance Efficiency pillar?',
    questionType: 'single_choice',
    options: [
      { id: 'a', text: 'Use serverless architectures' },
      { id: 'b', text: 'Implement strong identity foundation' },
      { id: 'c', text: 'Enable traceability' },
      { id: 'd', text: 'Perform operations as code' },
    ],
    correctAnswers: ['a'],
    explanation: 'Using serverless architectures is a design principle of the Performance Efficiency pillar. Serverless architectures remove the need for you to run and maintain physical servers for traditional compute activities.',
    referenceLinks: [
      { text: 'Performance Efficiency Pillar', url: 'https://docs.aws.amazon.com/wellarchitected/latest/performance-efficiency-pillar/design-principles.html' },
    ],
    difficulty: 'hard',
    isUnscored: false,
    tags: ['well-architected', 'performance-efficiency'],
