...
export const domain2Questions: Question[] = [
  ...
  },
  {
    ...
    questionType: 'single_choice',
    options: [
      { id: 'a', text: 'Securing the physical data center' },
      { id: 'b', text: 'Configuring AWS Identity and Access Management (IAM)' },
      { id: 'c', text: 'Patching the guest operating system on Amazon EC2' },
      { id: 'd', text: 'Encrypting customer data at rest' },
    ],
    correctAnswers: ['a'],
    explanation: 'Under the Shared Responsibility Model, AWS is responsible for "security OF the cloud," which includes securing the physical facilities, hardware, and the underlying infrastructure that runs AWS services. Patching guest OS, configuring IAM, and encrypting data are customer responsibilities ("security IN the cloud").',
    referenceLinks: [
  ...
  },
  {
    id: 'd2-032',
    domainId: 2,
    questionText: 'Which AWS service helps protect your web applications from common web exploits and vulnerabilities, such as SQL injection?',
    questionType: 'single_choice',
    options: [
      { id: 'a', text: 'AWS Shield' },
      { id: 'b', text: 'AWS WAF' },
    ...
    correctAnswers: ['b'],
    explanation: 'AWS WAF (Web Application Firewall) helps protect web applications or APIs against common web exploits and bots that may affect availability, compromise security, or consume excessive resources. It allows you to create rules to block patterns like SQL injection or cross-site scripting.',
    referenceLinks: [
  ...
  },
  {
    id: 'd2-033',
    domainId: 2,
    questionText: 'Which service provides on-demand access to AWS compliance reports, such as SOC and PCI reports?',
    questionType: 'single_choice',
    options: [
      { id: 'a', text: 'AWS Artifact' },
    ...
    referenceLinks: [
      { text: 'AWS Artifact', url: 'https://aws.amazon.com/artifact/' },
    ],
    difficulty: 'easy',
    isUnscored: false,
  ...
  },
  {
    id: 'd2-034',
    domainId: 2,
    questionText: 'A company needs to continuously monitor its AWS accounts and workloads for malicious activity and unauthorized behavior. Which service should they use?',
    questionType: 'single_choice',
    options: [
  ...
  },
  {
    id: 'd2-035',
    domainId: 2,
    questionText: 'What is the primary function of AWS Key Management Service (AWS KMS)?',
    questionType: 'single_choice',
    options: [
      { id: 'a', text: 'Managing user identities and passwords' },
      { id: 'b', text: 'Creating and managing cryptographic keys' },
      { id: 'c', text: 'Storing multi-factor authentication (MFA) tokens' },
      { id: 'd', text: 'Providing SSL/TLS certificates for websites' },
    ],
    correctAnswers: ['b'],
    ...
    referenceLinks: [
      { text: 'AWS KMS', url: 'https://aws.amazon.com/kms/' },
    ],
    difficulty: 'easy',
    isUnscored: false,
  ...
  },
  {
    id: 'd2-036',
    domainId: 2,
    questionText: 'Which AWS service uses machine learning to automatically discover, classify, and protect sensitive data in AWS?',
    questionType: 'single_choice',
    options: [
    ...
    difficulty: 'medium',
    isUnscored: false,
    tags: ['macie', 'data-security', 'machine-learning'],
  },
  {
    id: 'd2-037',
    domainId: 2,
    questionText: 'When granting permissions to users in AWS IAM, which best practice should be followed?',
    questionType: 'single_choice',
    options: [
      { id: 'a', text: 'Grant full access to all resources initially and restrict later' },
      { id: 'b', text: 'Grant least privilege' },
      { id: 'c', text: 'Use inline policies for all users' },
      { id: 'd', text: 'Share AWS account root user credentials' },
    ],
    correctAnswers: ['b'],
    explanation: 'Granting least privilege means granting only the permissions required to perform a task. It is a fundamental security best practice in AWS IAM to prevent unauthorized access or accidental changes.',
    referenceLinks: [
      { text: 'IAM Best Practices', url: 'https://docs.aws.amazon.com/IAM/latest/UserGuide/best-practices.html' },
    ],
    difficulty: 'easy',
    isUnscored: false,
    tags: ['iam', 'best-practices', 'least-privilege'],
  },
  {
    id: 'd2-038',
    domainId: 2,
    questionText: 'Which of the following services provides managed DDoS protection for applications running on AWS?',
    questionType: 'single_choice',
    options: [
      { id: 'a', text: 'AWS WAF' },
      { id: 'b', text: 'AWS Shield' },
    ...
    correctAnswers: ['b'],
    explanation: 'AWS Shield is a managed Distributed Denial of Service (DDoS) protection service that safeguards applications running on AWS. Shield Standard provides automatic protection for all AWS customers at no extra charge, and Shield Advanced provides higher levels of protection.',
    referenceLinks: [
  ...
  },
  {
    id: 'd2-039',
    domainId: 2,
    questionText: 'A company needs to securely store, rotate, and manage database credentials. Which AWS service should they use?',
    questionType: 'single_choice',
    options: [
    ...
    referenceLinks: [
      { text: 'AWS Secrets Manager', url: 'https://aws.amazon.com/secrets-manager/' },
    ],
    difficulty: 'medium',
    isUnscored: false,
    tags: ['secrets-manager', 'security'],
  },
  {
    id: 'd2-040',
    domainId: 2,
    questionText: 'Which AWS service allows you to centrally manage and enforce security policies across multiple AWS accounts?',
    questionType: 'single_choice',
    options: [
      { id: 'a', text: 'AWS IAM' },
    ...
    correctAnswers: ['b'],
    explanation: 'AWS Organizations helps you centrally manage and govern your environment as you grow and scale your AWS resources. You can use Service Control Policies (SCPs) in AWS Organizations to centrally control permissions for the accounts in your organization.',
    referenceLinks: [
      { text: 'AWS Organizations', url: 'https://aws.amazon.com/organizations/' },
    ],
    difficulty: 'medium',
    isUnscored: false,
    tags: ['organizations', 'governance', 'security'],
  },
  {
    id: 'd2-041',
    domainId: 2,
    questionText: 'Which service provides a comprehensive view of your security alerts and security posture across your AWS accounts?',
    questionType: 'single_choice',
    options: [
      { id: 'a', text: 'AWS CloudTrail' },
      { id: 'b', text: 'AWS Security Hub' },
    ...
    correctAnswers: ['b'],
    explanation: 'AWS Security Hub is a cloud security posture management service that performs security best practice checks, aggregates alerts, and enables automated remediation. It gives you a comprehensive view of your security state in AWS.',
    referenceLinks: [
      { text: 'AWS Security Hub', url: 'https://aws.amazon.com/security-hub/' },
    ],
    difficulty: 'medium',
    isUnscored: false,
    tags: ['security-hub', 'compliance'],
  },
  {
    id: 'd2-042',
    domainId: 2,
    ...
    questionType: 'single_choice',
    options: [
      { id: 'a', text: 'To uniquely identify a human user' },
      { id: 'b', text: 'To securely store passwords for applications' },
      { id: 'c', text: 'To provide temporary security credentials for a trusted entity to access AWS resources' },
      { id: 'd', text: 'To define the network boundaries for a VPC' },
    ],
    correctAnswers: ['c'],
    explanation: 'An IAM role is an identity that you can create in your account that has specific permissions. Unlike an IAM user, a role does not have long-term credentials (password or access keys). Instead, it provides temporary security credentials to anyone or anything that assumes the role.',
    referenceLinks: [
  ...
  },
  {
    id: 'd2-043',
    domainId: 2,
    questionText: 'Under the Shared Responsibility Model, what is the customer responsible for when using Amazon RDS?',
    questionType: 'single_choice',
    options: [
      { id: 'a', text: 'Patching the underlying operating system' },
      { id: 'b', text: 'Managing the physical hardware' },
      { id: 'c', text: 'Optimizing the database schema and queries' },
      { id: 'd', text: 'Installing database software' },
    ],
    correctAnswers: ['c'],
    explanation: 'Amazon RDS is a managed service. AWS handles the underlying infrastructure, OS patching, and database software installation. The customer is responsible for configuring the database, optimizing schemas, setting up network access (security groups), and managing data.',
    referenceLinks: [
      { text: 'Shared Responsibility in RDS', url: 'https://aws.amazon.com/rds/features/security/' },
    ],
    difficulty: 'hard',
    isUnscored: false,
    tags: ['shared-responsibility', 'rds'],
  },
  {
    id: 'd2-044',
    domainId: 2,
    questionText: 'Which AWS service provides automated vulnerability management for Amazon EC2 instances and container images?',
    questionType: 'single_choice',
    options: [
      { id: 'a', text: 'AWS Shield' },
      { id: 'b', text: 'Amazon Inspector' },
    ...
    referenceLinks: [
      { text: 'Amazon Inspector', url: 'https://aws.amazon.com/inspector/' },
    ],
    difficulty: 'medium',
    isUnscored: false,
  ...
  },
  {
    id: 'd2-045',
    domainId: 2,
    questionText: 'A developer needs to review a history of all API calls made to their AWS account over the past 90 days. Which service should they consult?',
    questionType: 'single_choice',
    options: [
    ...
    correctAnswers: ['c'],
    explanation: 'AWS CloudTrail enables governance, compliance, operational auditing, and risk auditing of your AWS account. It records actions taken by a user, role, or an AWS service as events, allowing you to review API calls made within the account.',
    referenceLinks: [
